...
root.title("South Corner")

Tops=Frame(root,width=1550,height=100,bd=12,relief="raise")
Tops.pack(side=TOP)
lblTitle=Label(Tops,font=("ariel",50,"bold"),text="\t South Corner\t\t")
...
lblTitle=Label(f1,font=("ariel",18,"bold"),text="IDLI")
lblTitle.grid(row=0 , column=0)
...
Grilledidlis=Checkbutton(f1,text="Grilledidlis\t₹50",variable=x1,onvalue=1,offvalue=0,
...
MasalaIdli=Checkbutton(f1,text="MasalaIdli\t₹80",variable=x2,onvalue=1,offvalue=0,
...
RavaMasalaIdli=Checkbutton(f1,text="Rava Masala Idli\t₹70",variable=x3,onvalue=1,offvalue=0,
...
SoojiMasalaIdli=Checkbutton(f1,text="Sooji Masala Idli\t₹100",variable=x4,onvalue=1,offvalue=0,
...
SojiIdli=Checkbutton(f1,text="Soji Idli\t\t₹80",variable=x6,onvalue=1,offvalue=0,
...
friedidli=Checkbutton(f1,text="fried idli\t\t₹80",variable=x7,onvalue=1,offvalue=0,
...
ravaidlifried=Checkbutton(f1,text="rava idli fried\t₹90",variable=x8,onvalue=1,offvalue=0,
...
soojiFriedidli=Checkbutton(f1,text="sooji Fried idli\t₹100",variable=x9,onvalue=1,offvalue=0,
...
planeidli=Checkbutton(f1,text="plane idli\t₹30",variable=x11,onvalue=1,offvalue=0,
...
lbldess=Label(f2top,font=("ariel",18,"bold"),text="DOSA")
...
PlainDosa=Checkbutton(f2top,text="Plain Dosa\t\t₹100",variable=x12,onvalue=1,offvalue=0,
...
MasalaDosa=Checkbutton(f2top,text="Masala Dosa\t\t₹100",variable=x13,onvalue=1,offvalue=0,
...
RavaDosa=Checkbutton(f2top,text="Rava Dosa\t\t₹100",variable=x14,onvalue=1,offvalue=0,
...
RavaMasalaDosa=Checkbutton(f2top,text="Rava Masala Dosa\t₹100",variable=x15,onvalue=1,offvalue=0,
...
SoojiMasalaDosa=Checkbutton(f2top,text="SoojiMasala Dosa\t\t₹100",variable=x16,onvalue=1,offvalue=0,
...
lbldess=Label(f3top,font=("ariel",18,"bold"),text="DRINKS & MOCKTAILS")
...
cok=Checkbutton(f3top,text="Coke\t\t₹40",variable=x17,onvalue=1,offvalue=0,
...
moj=Checkbutton(f3top,text="Mojito\t\t₹120",variable=x18,onvalue=1,offvalue=0,
...
bm=Checkbutton(f3top,text="Bombay Collins\t₹130",variable=x19,onvalue=1,offvalue=0,
...
spt=Checkbutton(f3top,text="Spiced Tango\t₹180",variable=x20,onvalue=1,offvalue=0,
...
lir=Checkbutton(f3top,text="Lady in Red\t₹200",variable=x21,onvalue=1,offvalue=0,
...
fan=Checkbutton(f3top,text="Fanta\t\t₹30",variable=x22,onvalue=1,offvalue=0,
...
def costofmeal():
        ...
        cv_1=xTotal.get()
        cv_2=xSubTotal.get()   
        with open("Billl.csv",mode="a") as f: 
