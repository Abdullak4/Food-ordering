...
Tops.pack(side=TOP)
lblTitle=Label(Tops,font=("ariel",50,"bold"),text="\t Kareems Rolls\t\t")
...
lblTitle=Label(f1,font=("ariel",18,"bold"),text="Special Rolls")
lblTitle.grid(row=0 , column=0)
...
Grilledidlis=Checkbutton(f1,text="ButtonChickenRolls\t\t₹50",variable=x1,onvalue=1,offvalue=0,
...
MasalaIdli=Checkbutton(f1,text="MuttonBhunaRolls\t\t₹80",variable=x2,onvalue=1,offvalue=0,
...
RavaMasalaIdli=Checkbutton(f1,text="KalmiriTikkaRolls\t\t\t₹70",variable=x3,onvalue=1,offvalue=0,
...
SoojiMasalaIdli=Checkbutton(f1,text="ResmiTikkaRolls\t\t\t₹100",variable=x4,onvalue=1,offvalue=0,
...
RavaIdli=Checkbutton(f1,text="ChakoriRolls\t\t\t₹110",variable=x5,onvalue=1,offvalue=0,
...
SojiIdli=Checkbutton(f1,text="NizamiRolls\t\t\t₹80",variable=x6,onvalue=1,offvalue=0,
...
friedidli=Checkbutton(f1,text="Kebab Roll\t\t\t₹80",variable=x7,onvalue=1,offvalue=0,
...
ravaidlifried=Checkbutton(f1,text="AchariRoll\t\t\t₹90",variable=x8,onvalue=1,offvalue=0,
...
soojiFriedidli=Checkbutton(f1,text="BhunaRoll\t\t\t₹100",variable=x9,onvalue=1,offvalue=0,
...
planeidli=Checkbutton(f1,text="Chicken Roll\t\t\t₹30",variable=x11,onvalue=1,offvalue=0,
...
lbldess=Label(f2top,font=("ariel",18,"bold"),text="Main Course")
...
PlainDosa=Checkbutton(f2top,text="ButterChicken\t\t\t₹100",variable=x12,onvalue=1,offvalue=0,
...
MasalaDosa=Checkbutton(f2top,text="Chicken Tikka Masala\t\t₹100",variable=x13,onvalue=1,offvalue=0,
...
RavaDosa=Checkbutton(f2top,text="Sia Mirch\t\t\t₹100",variable=x14,onvalue=1,offvalue=0,
...
RavaMasalaDosa=Checkbutton(f2top,text="Lahori\t\t\t\t₹100",variable=x15,onvalue=1,offvalue=0,
...
SoojiMasalaDosa=Checkbutton(f2top,text="Shahi Korma\t\t\t₹100",variable=x16,onvalue=1,offvalue=0,
...
lbldess=Label(f3top,font=("ariel",18,"bold"),text="IndianBreads")
...
cok=Checkbutton(f3top,text="TandooriRoti\t\t₹40",variable=x17,onvalue=1,offvalue=0,
...
moj=Checkbutton(f3top,text="ButterRoti\t\t₹120",variable=x18,onvalue=1,offvalue=0,
...
bm=Checkbutton(f3top,text="Naan\t\t\t₹130",variable=x19,onvalue=1,offvalue=0,
...
spt=Checkbutton(f3top,text="Cheese Naan\t\t₹180",variable=x20,onvalue=1,offvalue=0,
...
lir=Checkbutton(f3top,text="AlooKulcha\t\t₹200",variable=x21,onvalue=1,offvalue=0,
...
fan=Checkbutton(f3top,text="RotiBasket\t\t₹30",variable=x22,onvalue=1,offvalue=0,
...
def order():
    ...
    if messagebox.showinfo("Kareems Roll","Thank you for ordering " ):
        root.destroy()
...
def exit():
    ...
    if messagebox.askyesno("Kareems Roll","ARE u sure u want to exit " )== True:
...
def costofmeal():
        ...
        cv_1=xTotal.get()
        cv_2=xSubTotal.get()   
        with open("Billnonveg.csv",mode="a") as f: 
