...
Tops=Frame(root,width=1900,height=100,bd=12,relief="raise")
Tops.pack(side=TOP)
lblTitle=Label(Tops,font=("ariel",50,"bold"),text="\t Street Style Food\t\t")
lblTitle.grid(row=0 , column=0)
btmmainframe=Frame(root,width=1900,height=650,bd=12,relief="raise")
btmmainframe.pack(side=BOTTOM)


f1=Frame(btmmainframe,width=450,height=650,bd=12,relief="raise")
f1.pack(side=LEFT)
f2=Frame(btmmainframe,width=350,height=450,bd=12,relief="raise")
f2.pack(side=LEFT)
...
lblTitle=Label(f1,font=("ariel",18,"bold"),text="Sandwich")
lblTitle.grid(row=0 , column=0)
...
Grilledidlis=Checkbutton(f1,text="Bombay Sandwich\t\t₹50",variable=x1,onvalue=1,offvalue=0,
...
MasalaIdli=Checkbutton(f1,text="BombayCheeseSandwich\t\t₹80",variable=x2,onvalue=1,offvalue=0,
...
RavaMasalaIdli=Checkbutton(f1,text="CheeseSandwitch\t\t\t₹70",variable=x3,onvalue=1,offvalue=0,
...
SoojiMasalaIdli=Checkbutton(f1,text="GrilledSandwitch\t\t\t₹100",variable=x4,onvalue=1,offvalue=0,
...
RavaIdli=Checkbutton(f1,text="SpringRollSandwich\t\t₹110",variable=x5,onvalue=1,offvalue=0,
...
SojiIdli=Checkbutton(f1,text="KababSandwich\t\t\t₹80",variable=x6,onvalue=1,offvalue=0,
...
friedidli=Checkbutton(f1,text="MexicanSandwich\t\t₹80",variable=x7,onvalue=1,offvalue=0,
...
ravaidlifried=Checkbutton(f1,text="PaneetTikkaSandwich\t\t₹90",variable=x8,onvalue=1,offvalue=0,
...
soojiFriedidli=Checkbutton(f1,text="ClubSandwich\t\t\t₹100",variable=x9,onvalue=1,offvalue=0,
...
planeidli=Checkbutton(f1,text="ItalianSandwich\t\t\t₹30",variable=x11,onvalue=1,offvalue=0,
...
lbldess=Label(f2top,font=("ariel",18,"bold"),text="Pizzas")
...
PlainDosa=Checkbutton(f2top,text="ItalianPizza\t\t₹100",variable=x12,onvalue=1,offvalue=0,
...
MasalaDosa=Checkbutton(f2top,text="MexicanPizza\t\t₹100",variable=x13,onvalue=1,offvalue=0,
...
RavaDosa=Checkbutton(f2top,text="TanddoriPizza\t\t₹100",variable=x14,onvalue=1,offvalue=0,
...
RavaMasalaDosa=Checkbutton(f2top,text="LahoriPizza\t\t₹100",variable=x15,onvalue=1,offvalue=0,
...
SoojiMasalaDosa=Checkbutton(f2top,text="PaneetTikkaPizza\t\t₹100",variable=x16,onvalue=1,offvalue=0,
...
lbldess=Label(f3top,font=("ariel",18,"bold"),text="Drinks")
...
cok=Checkbutton(f3top,text="ChoclateMilkShake\t\t₹40",variable=x17,onvalue=1,offvalue=0,
...
moj=Checkbutton(f3top,text="OreoMilkshake\t\t\t₹120",variable=x18,onvalue=1,offvalue=0,
...
bm=Checkbutton(f3top,text="FrappeLate\t\t\t₹130",variable=x19,onvalue=1,offvalue=0,
...
spt=Checkbutton(f3top,text="HazelNutFrappe\t\t\t₹180",variable=x20,onvalue=1,offvalue=0,
...
lir=Checkbutton(f3top,text="ChoclateFrappe\t\t\t₹200",variable=x21,onvalue=1,offvalue=0,
...
fan=Checkbutton(f3top,text="Frappe\t\t\t\t₹30",variable=x22,onvalue=1,offvalue=0,
...
def order():
    ...
    if messagebox.showinfo("Street style foods ","Thank you for ordering " ):
        root.destroy()
...
def exit():
    ...
    if messagebox.askyesno("Street style foodss","ARE u sure u want to exit " )== True:
...
def costofmeal():
        ...
        cv_1=xTotal.get()
        cv_2=xSubTotal.get()   
        with open("Billstreet.csv",mode="a") as f: 
